...
public class Constants {
  ...
  public static final String PLUGIN_DESCRIPTION = "Detection of likely program invariants using Daikon.";
  ...
  public static final String CODE_GEN_TASK_DESCRIPTION = "Generates test driver code that Daikon can execute.";
  ...
  public static final Pattern EXPECTED_JUNIT4_NAME_REGEX = Pattern.compile(".+Test\\d*|.+Tests\\d*|Test.+|Tests.+|.+IT|.+ITs|.+TestCase\\d*" + "|.+TestCases\\d*");
  ...
  public static final String SUCCESSFUL_DAIKON_EXECUTION = "Daikon task was successfully executed. All files generated by "
      + NEW_LINE + "this task would be located in the Daikon output directory "
      + NEW_LINE + "specified in your project's build.gradle";

  public static final String SUCCESSFUL_CODE_GENERATION = "Successful generation of test driver code. The Java files generated by "
      + NEW_LINE + "this task would be located in the Daikon output directory "
      + NEW_LINE + "specified in your project's build.gradle";
